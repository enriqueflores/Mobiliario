...
public class AdaptadorChat extends RecyclerView.Adapter<AdaptadorChat.PaletteViewHolder> {
    static public List<ConstructorChat> data;
    private static ClickeadorChat recyclerViewOnItemClickListener;
    int colorId;
    int selectedPosition;
    View row;

    public AdaptadorChat(@NonNull List<ConstructorChat> data,
                         @NonNull ClickeadorChat
    ...
    public PaletteViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
         row = LayoutInflater.from(parent.getContext()).inflate(R.layout.rowchat, parent, false);
    ...
    public void onBindViewHolder(PaletteViewHolder holder, int position) {
        ...
        ConstructorChat color = data.get(position);

        holder.getIcono().setText(color.getIcono());


        List<ConstructorChat> i = data;
